...
assert_equals "$(xpath_string '/*/@xml:lang')" "zh-TW" "xml:lang must stay aligned with this repository"
assert_equals "$(xpath_string '/*/@alphabet')" "x-microsoft-sapi" "alphabet must stay aligned with Azure zh-TW custom lexicon support"
